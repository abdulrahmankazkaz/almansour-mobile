...
/// @nodoc
mixin _$Attachment {
  @JsonKey(fromJson: Attachment.idFromJson)
...
abstract class $AttachmentCopyWith<$Res> {
  ...
  @useResult
  $Res call({@JsonKey(fromJson: Attachment.idFromJson) String id, String url});
}
...
class _$AttachmentImpl extends _Attachment {
  const _$AttachmentImpl(
      {@JsonKey(fromJson: Attachment.idFromJson) this.id = '', this.url = ''})
      : super._();
...
abstract class _Attachment extends Attachment {
  const factory _Attachment(
      {@JsonKey(fromJson: Attachment.idFromJson) final String id,
