...
import '../data_sources/survey_datasource.dart';

class SurveyRepositoryImplementation implements SurveyRepository {
  final SurveyDatasource datasource;

  final NetworkInfo _networkInfo;

  SurveyRepositoryImplementation(this.datasource, this._networkInfo);


  @override
  Future<Result<DefaultSuccessModel, FailureModel>> sendSurvey(SurveyParameters parameters) async {
    if (await _networkInfo.isConnected) {
      try {
        final response = await datasource.sendSurvey(parameters);
