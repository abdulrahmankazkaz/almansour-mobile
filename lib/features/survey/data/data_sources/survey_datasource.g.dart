...
part of 'survey_datasource.dart';
...
class _SurveyDatasource implements SurveyDatasource {
  _SurveyDatasource(this._dio, {this.baseUrl, this.errorLogger}) {
