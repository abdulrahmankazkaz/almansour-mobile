...
import '../datasources/spare_parts_datasource.dart';

class SparePartsRepositoryImplementation implements SparePartsRepository {
  final SparePartsDatasource datasource;

  final NetworkInfo _networkInfo;
  SparePartsRepositoryImplementation(this.datasource, this._networkInfo);

  @override
  Future<Result<List<SparePart>, FailureModel>> getSpareParts() async {
    if (await _networkInfo.isConnected) {
      try {
        final response = await datasource.getSpareParts();
