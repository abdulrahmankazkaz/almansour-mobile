    ...
    return BlocBuilder<SparePartsBloc, SparePartsState>(
      builder: (context, state) {
        return Scaffold(
          ...
          floatingActionButton: Stack(alignment: Alignment.topRight, children: [
          ...
          body: ScreenContainer(
            padding:
                EdgeInsets.only(top: MediaQuery.sizeOf(context).height * 0.18),
            child: RefreshIndicator(
              backgroundColor: Theme.of(context).cardColor,
              onRefresh: () async => context.read<SparePartsBloc>().add(const SparePartsEvent.getSpareParts(refresh: true)),
                      ...
                      child: Column(mainAxisSize: MainAxisSize.max, children: [
                        CustomTextField(
                          onChanged: (value) => context
                              .read<SparePartsBloc>()
                              .add(SparePartsEvent.searchSpareParts(value)),
                          hint: LocaleKeys.search.tr(),
                          suffixIcon: const Icon(AppIcons.search),
                        ),
                        state.maybeWhen(
                            loaded: (spareParts) => ListView.builder(
                                shrinkWrap: true,
                                physics: const NeverScrollableScrollPhysics(),
                                padding: EdgeInsets.only(
                                    top: AppSizeH.s30, bottom: AppSizeH.s80),
                            ...
                            loading: () => Padding(
                              ...
                              child: SkeletonListLoading(height: MediaQuery.sizeOf(context).height*0.11),
                            ),
                            orElse: () => Padding(
                                padding: EdgeInsets.all(AppSizeH.s150),
