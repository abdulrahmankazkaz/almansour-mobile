...
class InstallmentRepositoryImplementation
    implements InstallmentRepository {
  final InstallmentDatasource datasource;

  final NetworkInfo _networkInfo;

  InstallmentRepositoryImplementation(this.datasource, this._networkInfo);



  @override
  Future<Result<List<InstallmentRequirement>, FailureModel>> getInstallmentRequirements() async {
    if (await _networkInfo.isConnected) {
      try {
        final response = await datasource.getInstallmentRequirements();
