...
class GetMobileServiceType implements BaseUseCase<NoParams, DefaultDataModel<List<BasicModel>>> {
  final MobileServiceRepository repository;

  GetMobileServiceType(this.repository);

  @override
  Future<Result<DefaultDataModel<List<BasicModel>>, FailureModel>> execute(NoParams parameters) async {
    return await repository.getMobileServiceType();
  }
}
