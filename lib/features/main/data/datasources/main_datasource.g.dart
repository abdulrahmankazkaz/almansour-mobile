...
class _MainDatasource implements MainDatasource {
  ...
  @override
  Future<HttpResponse<DefaultDataModel<ImageEntity>>> uploadImage(
    File image,
  ) async {
    ...
    final _options =
        _setStreamType<HttpResponse<DefaultDataModel<ImageEntity>>>(
      Options(
        method: 'POST',
        headers: _headers,
        extra: _extra,
        contentType: 'multipart/form-data',
          ...
          .compose(
            _dio.options,
            '/api/customers/uploads/image-private',
    ...
    late DefaultDataModel<ImageEntity> _value;
    try {
      _value = DefaultDataModel<ImageEntity>.fromJson(
        _result.data!,
        (json) => ImageEntity.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
  ...
  Future<HttpResponse<DefaultDataModel<List<BasicModel>>>>
    ...
    final _options =
      ...
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/customers/utilities/enums/order-type',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(
  ...
  Future<HttpResponse<DefaultDataModel<List<BasicModel>>>>
    ...
    final _options =
      ...
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/customers/utilities/enums/payment-method',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(
