...
import '../data_sources/geofencing_data_source.dart';


class GeofencingRepositoryImplementation implements GeofencingRepository {
  final GeofencingDatasource datasource;

  final NetworkInfo _networkInfo;
  GeofencingRepositoryImplementation(this.datasource, this._networkInfo);



  @override
  Future<Result<List<ServiceCenter>, FailureModel>> getCentersLocation() async {
    if (await _networkInfo.isConnected) {
      try {
        final response = await datasource.getServiceCenters();
