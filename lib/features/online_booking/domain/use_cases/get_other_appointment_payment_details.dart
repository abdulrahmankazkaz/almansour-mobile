...
class GetOtherAppointmentPaymentDetails implements BaseUseCase<AppointmentPaymentParameters, DefaultDataModel<OrderDetails>> {
  final BookingRepository repository;

  GetOtherAppointmentPaymentDetails(this.repository);

  @override
  Future<Result<DefaultDataModel<OrderDetails>, FailureModel>> execute(
      AppointmentPaymentParameters parameters) async {
    return repository.getOtherAppointmentPaymentDetails(parameters);
  }
}
